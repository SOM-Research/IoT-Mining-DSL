...
public class Sensor_Events_Constraints extends BaseConstraintsDescriptor {
  public Sensor_Events_Constraints() {
    super(CONCEPTS.Sensor_Events$lo);
  }
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return new SNodePointer("r:ef5b13d7-d5e8-4ebf-a18f-76c256afe20a(Mining.constraints)", "5982629958615616712");
          }
          @Override

...
public final class Node__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x23381bd32c685983L, "Mining.structure.Node");

  public static final SMethod<Boolean> sameName_id3N5eeeLPxzb = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("sameName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3N5eeeLPxzb").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Integer> availableMemory_id5c6$$011Azd = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("availableMemory").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5c6$$011Azd").build();
  public static final SMethod<Integer> availableCPU_id5c6$$016dlQ = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("availableCPU").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5c6$$016dlQ").build();

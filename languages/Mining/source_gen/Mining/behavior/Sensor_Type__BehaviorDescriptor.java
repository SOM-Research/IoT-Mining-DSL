...
public final class Sensor_Type__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x23381bd32c6859b3L, "Mining.structure.Sensor_Type");
  ...
  public static final SMethod<Boolean> checkPoint_id5SDFqzTmf_L = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("checkPoint").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5SDFqzTmf_L").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(checkRegion_id5c6$$01W3Px, checkPoint_id5SDFqzTmf_L);
  ...
  /*package*/ static boolean checkRegion_id5c6$$01W3Px(@NotNull SNode __thisNode__, SNode r) {
    ...
    for (SNode s : SNodeOperations.ofConcept(SLinkOperations.collectMany(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(r, CONCEPTS.IoT_System$Z$, false, false), LINKS.checkPoints$Z6Dw), LINKS.iotDevices$Zd2V), CONCEPTS.Sensor$8w)) {
      if (SLinkOperations.getTarget(s, LINKS.type$LV3W) == __thisNode__) {
        for (SNode reg : SLinkOperations.getChildren(s, LINKS.regions$svWv)) {
          if (SLinkOperations.getTarget(reg, LINKS.region$yC9l) == r) {
            return true;
  ...
  /*package*/ static boolean checkPoint_id5SDFqzTmf_L(@NotNull SNode __thisNode__, SNode cp) {
    for (SNode s : SNodeOperations.ofConcept(SLinkOperations.getChildren(cp, LINKS.iotDevices$Zd2V), CONCEPTS.Sensor$8w)) {
      if (SLinkOperations.getTarget(s, LINKS.type$LV3W) == __thisNode__) {
        return true;
      }
    }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 1:
        return (T) ((Boolean) checkPoint_id5SDFqzTmf_L(node, (SNode) parameters[0]));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }

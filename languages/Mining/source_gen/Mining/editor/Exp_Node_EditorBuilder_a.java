...
/*package*/ class Exp_Node_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Exp_Node_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_l9r7us_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.node$W9eU;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.node$W9eU);
    }

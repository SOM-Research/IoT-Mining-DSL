...
/*package*/ class Node_Reference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Node_Reference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_gk2yfj_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.node$Oeii;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.node$Oeii);
    }

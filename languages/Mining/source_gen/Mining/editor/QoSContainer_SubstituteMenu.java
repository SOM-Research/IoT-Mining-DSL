...
public class QoSContainer_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for QoSContainer. Generated from the smart reference attribute.", new SNodePointer("r:589c5fd8-b628-4aae-9e87-31a99b5068a7(Mining.structure)", "2718605664465766211")));
    try {

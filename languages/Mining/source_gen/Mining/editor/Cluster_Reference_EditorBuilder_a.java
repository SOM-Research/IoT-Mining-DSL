...
/*package*/ class Cluster_Reference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Cluster_Reference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_bt8jn7_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cluster$OdYU;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cluster$OdYU);
    }

...
public class Sensor_Events_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for Sensor_Events. Generated from the smart reference attribute.", new SNodePointer("r:589c5fd8-b628-4aae-9e87-31a99b5068a7(Mining.structure)", "5982629958609110369")));
    try {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept Sensor_Events$lo = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x53069240016af7c7L, "Mining.structure.Sensor_Events");
  }

...
/*package*/ class Container_Reference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Container_Reference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_cfap3z_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_cfap3z_a0");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Broker:");
    editorCell.setCellId("Constant_cfap3z_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.container$ktVU;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.container$ktVU);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.container$ktVU);
    }
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_cfap3z_c0a");
  ...
  private EditorCell createCollection_3() {
    ...
    editorCell.setCellId("Collection_cfap3z_a2a0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_4() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_cfap3z_a0a0c0a");
      editorCell.addEditorCell(createRefNodeList_0());
      return editorCell;
    }
    private EditorCell createRefNodeList_0() {
      AbstractCellListHandler handler = new topicsListHandler_cfap3z_a0a0a2a0(myNode, getEditorContext());
      EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
      editorCell.setCellId("refNodeList_topics");
      editorCell.setSRole(handler.getElementSRole());
      return editorCell;
    }
    private static class topicsListHandler_cfap3z_a0a0a2a0 extends RefNodeListHandler {
      @NotNull
      private SNode myNode;

      public topicsListHandler_cfap3z_a0a0a2a0(SNode ownerNode, EditorContext context) {
        super(context, false);
        myNode = ownerNode;
      }
      ...
      public SContainmentLink getSLink() {
        return LINKS.topics$Q2I_;
      }
      public SAbstractConcept getChildSConcept() {
        return CONCEPTS.Topic$9a;
      }
      ...
      public EditorCell createEmptyCell() {
        getCellFactory().pushCellContext();
        getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(topicsListHandler_cfap3z_a0a0a2a0.this.getNode(), LINKS.topics$Q2I_));
        try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_cfap3z_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Topic$9a = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x624a077add07cc36L, "Mining.structure.Topic");
  }

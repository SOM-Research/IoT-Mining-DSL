...
/*package*/ class Container_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_xjnu6t_b0");
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_xjnu6t_a1a");
    ...
    if (nodeCondition_xjnu6t_a8a1a()) {
      editorCell.addEditorCell(createConstant_6());
    }
    editorCell.addEditorCell(createConstant_7());
    editorCell.addEditorCell(createConstant_8());
    editorCell.addEditorCell(createProperty_3());
    if (nodeCondition_xjnu6t_a21a1a()) {
      editorCell.addEditorCell(createConstant_9());
    }
    return editorCell;
  }
  private boolean nodeCondition_xjnu6t_a8a1a() {
    return SPropertyOperations.getInteger(myNode, PROPS.memoryLimit$Pi9U) != 0;
  }
  private boolean nodeCondition_xjnu6t_a21a1a() {
    return SPropertyOperations.getInteger(myNode, PROPS.cpuLimit$PhFS) != 0;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Name:");
    editorCell.setCellId("Constant_xjnu6t_a0b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ",");
    editorCell.setCellId("Constant_xjnu6t_c0b0");
  ...
  private EditorCell createConstant_3() {
    ...
    editorCell.setCellId("Constant_xjnu6t_d0b0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.application$GqFB;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.application$GqFB);
    ...
    provider.setNoTargetText("<no app>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.application$GqFB);
    }
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ",");
    editorCell.setCellId("Constant_xjnu6t_f0b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_xjnu6t_g0b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.memoryLimit$Pi9U;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, true), myNode);
      editorCell.setDefaultText("no limit");
      editorCell.setCellId("property_memoryLimit");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_6() {
    ...
    editorCell.setCellId("Constant_xjnu6t_i0b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ",");
    editorCell.setCellId("Constant_xjnu6t_j0b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_8() {
    ...
    editorCell.setCellId("Constant_xjnu6t_k0b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_3() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.cpuLimit$PhFS;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, true), myNode);
      editorCell.setDefaultText("no limit");
      editorCell.setCellId("property_cpuLimit");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
  ...
  private EditorCell createConstant_9() {
    ...
    editorCell.setCellId("Constant_xjnu6t_m0b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_xjnu6t_b1a");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_10() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Volumes:");
    editorCell.setCellId("Constant_xjnu6t_a1b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createCollection_4() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Vertical());
    editorCell.setCellId("Collection_xjnu6t_b1b0");
    editorCell.addEditorCell(createRefNodeList_0());
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new volumesListHandler_xjnu6t_a1b1a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_volumes");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class volumesListHandler_xjnu6t_a1b1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public volumesListHandler_xjnu6t_a1b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.volumes$EF4i;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Volume$5d;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(volumesListHandler_xjnu6t_a1b1a.this.getNode(), LINKS.volumes$EF4i));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Volume$5d = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x1df32ba8689ddf66L, "Mining.structure.Volume");
  }

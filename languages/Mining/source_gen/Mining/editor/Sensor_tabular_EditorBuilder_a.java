...
/*package*/ class Sensor_tabular_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createTableCell_8gfsze_k0a(final EditorContext editorContext, final SNode node) {

    EditorCell cell = createProperty_8();
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
    ...
    grid.setColumnHeaders(0, 0, createStaticHeader_8gfsze_a01a0(editorContext, node));

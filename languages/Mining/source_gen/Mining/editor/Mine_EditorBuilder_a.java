...
/*package*/ class Mine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Mine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createTreeCell_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("TreeCell_rw18j0_a");
    editorCell.setBig(true);
    setCellContext(editorCell);
    Style style = new StyleImpl();
    style.set(StyleAttributes.getInstance().<Integer>getAttribute("com.mbeddr.mpsutil.treenotation.styles", "tree-level-spacing"), _StyleParameter_QueryFunction_rw18j0_a0a());
    style.set(StyleAttributes.getInstance().<Integer>getAttribute("com.mbeddr.mpsutil.treenotation.styles", "tree-node-spacing"), _StyleParameter_QueryFunction_rw18j0_a1a());
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_rw18j0_a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createJComponent_0() {
    EditorCell editorCell = EditorCell_Component.createComponentCell(getEditorContext(), myNode, _QueryFunction_JComponent_rw18j0_a0a0(), "JComponent_rw18j0_a0a");
    editorCell.setCellId("JComponent_rw18j0_a0a_0");
    return editorCell;
  }
  private JComponent _QueryFunction_JComponent_rw18j0_a0a0() {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new subregionsListHandler_rw18j0_a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_subregions");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class subregionsListHandler_rw18j0_a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public subregionsListHandler_rw18j0_a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subregionsListHandler_rw18j0_a0.this.getNode(), LINKS.subregions$innj));
      try {
  ...
  private int _StyleParameter_QueryFunction_rw18j0_a0a() {
    return 50;
  }
  private int _StyleParameter_QueryFunction_rw18j0_a1a() {
    return 50;
  }
